...
# نام منبع، بالای هر پیام. دستور حمید (۱۶ اوت): «سیگنال‌هایی که از تلگرام
# می‌فرستی باید به اسم aura liam mAx باشد تا بدانم کدام سیگنال از کدام
# منبع است.» چند پنل هم‌زمان به همین کانال می‌فرستند؛ بدون این برچسب،
# کارنامهٔ دو منبع با هم قاتی می‌شود و مقایسه‌شان بی‌معنا.
PANEL_NAME = "aura liam mAx"
